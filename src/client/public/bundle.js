...
/***/ function(module, exports, __webpack_require__) {
	...
	var UsersMap = React.createClass({
	  ...
	  */
	  ...
	  getData: function getData(location, lat, lon) {
	  ...
	  * Update state
	  */
	  updateState: function updateState(locationName, lat, lon) {
	   ...
	   */
	  updateMap: function updateMap(lat, lon) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', { id: 'map', style: divStyle });
	  }
	});
	 ...
	 * Slap it on the page
	 */
	ReactDOM.render(React.createElement(UsersMap, { initialLat: config.initialLat, initialLon: config.initialLon }), document.getElementById('app'));
